...
const AllGames = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
            ...
            <div className="py-12 px-4 mb-8">
                <div className="max-w-7xl mx-auto text-center space-y-6">
                    <h1 className="text-4xl md:text-5xl font-bold space-mono dark:text-white">
                        Browse All{" "}
                    ...
                    <div className="flex items-center gap-2 justify-center">
                        <p className="text-orange-400 text-2xl"> | </p>
                        <p className="text-gray-600 dark:text-gray-300 space-mono">
                            Discover your next favorite retro game
                        </p>
                    </div>
                    ...
                    <div className="max-w-2xl mx-auto mt-8">
                        <div className="relative">
                            <input
                                ...
                                placeholder="SEARCH GAMES..."
                                className="w-full px-6 py-4 text-sm font-semibold rounded-xl
                                       border-4 border-black dark:border-cyan-400 
                                       bg-white dark:bg-gray-800 
                                       text-black dark:text-white
                                       placeholder:text-gray-400 dark:placeholder:text-gray-500 
                                       placeholder:text-sm placeholder:font-bold
                                       focus:outline-none focus:ring-2 focus:ring-orange-400 
                                       space-mono transition-colors"
                            />
                            <svg
                                className="absolute right-4 top-1/2 -translate-y-1/2 h-6 w-6 opacity-50 dark:text-white"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                            >
                                <g
                    ...
                    {(selectedCategory || search) && (
                        <div className="flex items-center justify-center gap-3 flex-wrap">
                            {selectedCategory && (
                                <span className="px-4 py-2 bg-orange-400 border-2 border-black dark:border-cyan-400 text-sm font-bold space-mono flex items-center gap-2">
                                    {selectedCategory}
                                    <button
                                        onClick={() => setSelectedCategory('')}
                                        className="hover:scale-110 transition-transform"
                            ...
                            <button
                                onClick={clearFilters}
                                className="px-4 py-2 bg-white dark:bg-gray-800 border-2 border-black dark:border-cyan-400 text-sm font-bold space-mono hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors dark:text-white"
                            >
                                Clear All
                            </button>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-12">
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <aside className="w-full md:w-64 md:sticky md:top-24 h-fit">
                        <div className="border-4 border-black dark:border-cyan-400 bg-white dark:bg-gray-800 transition-colors">
                            
                            <div className="p-4 bg-orange-400 border-b-4 border-black dark:border-cyan-400">
                                <h2 className="font-bold text-lg space-mono uppercase text-center">
                                    Filter
                                </h2>
                            </div>
  
                            <div className="p-3 border-t-4 border-black dark:border-cyan-400">
                                <h3 className="font-bold text-sm space-mono uppercase mb-2 dark:text-white">Sort By</h3>
                                <div className="space-y-2">
                                    <button
                                        onClick={toggleSortOrder}
                                        className="w-full p-2 border-2 border-black dark:border-cyan-400 font-semibold space-mono text-sm bg-white dark:bg-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors rounded flex items-center justify-center gap-2"
                                    >
                                        {sortOrder === 'asc' ? (
                                            <>
                                    ...
                                    <select
                                        ...
                                        className="w-full p-2 border-2 border-black dark:border-cyan-400 font-semibold space-mono text-sm bg-white dark:bg-gray-700 dark:text-white rounded focus:outline-none focus:ring-2 focus:ring-orange-400"
                                    >
                            ...
                            <div className="p-3 border-t-4 border-black dark:border-cyan-400 bg-[#00D9FF] text-center">
                                <p className="text-sm font-bold space-mono">
                    ...
                    <main className="flex-1">
                        {sortedGames.length > 0 ? (
                            ...
                            <div className="border-4 border-black dark:border-cyan-400 p-12 text-center bg-white dark:bg-gray-800 transition-colors">
                                <div className="text-6xl mb-4">🎮</div>
                                <h3 className="text-2xl font-bold space-mono mb-2 dark:text-white">No Games Found</h3>
                                <p className="text-gray-600 dark:text-gray-300 mb-6">
                                    Try adjusting your search or filters
                                </p>
                                <button
                                    onClick={clearFilters}
                                    className="px-6 py-3 bg-orange-400 text-white font-bold border-2 border-black dark:border-cyan-400
                                             hover:translate-x-0.5 hover:translate-y-0.5
                                             hover:shadow-[3px_3px_0px_black] dark:hover:shadow-[3px_3px_0px_#00D9FF] transition-all space-mono"
                                >
                                    Clear Filters
                                </button>
                            </div>
