                ...
                >
                    ...
                    <div className="relative z-20 border-2 p-4 border-black">
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="flex items-center">
                                <span className="text-amber-300 pr-2">&gt;</span>
                                <span className="text-blue-500 font-bold">CONNECTION REFUSED.</span> Resource path does not compute.
                            </p>
                            <p className="flex items-center">
                                <span className="text-orange-300 pr-2">&gt;</span>
                            ...
                            <div className="pt-6">
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 border-2 border-orange-400 text-orange-400 text-lg uppercase font-bold tracking-widest transition-all duration-300 hover:bg-amber-900/50 rounded-md active:bg-amber-900"
                        ...
                        <footer className="mt-8 pt-4 border-t border-orange-500/50">
                            <p className="text-sm text-gray-500">
                                &gt; System Status: <span className="text-orange-500 font-bold">NON-CRITICAL FAILURE</span>
                            </p>
                            <p className="text-sm text-gray-500">
                                &gt; Console Ready...
                            </p>
