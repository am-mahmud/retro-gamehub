      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="hover:text-black cursor-pointer">Arcade Classics</li>
            <li className="hover:text-black cursor-pointer">Platform Games</li>
            <li className="hover:text-black cursor-pointer">Puzzle Games</li>
            <li className="hover:text-black cursor-pointer">Action Games</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="hover:text-black cursor-pointer">Blog & News</li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="hover:text-black cursor-pointer">Discord Community</li>
